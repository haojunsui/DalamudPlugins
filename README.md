...
2. Paste `https://raw.githubusercontent.com/haojunsui/DalamudPlugins/master/pluginmaster.json` into the empty box at the bottom of the "Custom Plugin Repositories" section (the last box will always have a + next to it).
3. Click the + button.
